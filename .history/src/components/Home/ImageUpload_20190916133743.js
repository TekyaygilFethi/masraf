                                    ...
                                    <div className="m-1 w-100">
...

                                        {
                                            activeStep===1 &&(
                                                ...
                                                aria-haspopup="true"
                                                onMouseEnter={this.handlePopoverOpen} onMouseLeave={this.handlePopoverClose}  src={this.state.imageUrl} className="roundeds avatar-lg img-thumbnail float-right" alt={this.state.imageTitle} />                                            
                                                ...
                                                disableRestoreFocus
                                              >
                                                <img src={this.state.imageUrl} className="roundeds avatar-xxl img-thumbnail float-right" alt={this.state.imageTitle} />
                                                </Popover>
                                                </>
                                            )
                                        }
