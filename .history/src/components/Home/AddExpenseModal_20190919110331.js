...
class AddExpenseModal extends Component {
    ...
    componentWillReceiveProps(nextProps) {
        debugger;
        const tabIndexValue = nextProps.activeIndexValue.data;
        let uploadImageList = null;

        if (this.state.open === false && nextProps.modal.modalToggle === true) {
            nextProps.pushArray("ExpenseForm", "contents", "")
        }


        if (!_.isUndefined(nextProps.uploadImageList.data) && this.state.uploadImageList !== nextProps.uploadImageList.data) {
            uploadImageList = nextProps.uploadImageList.data;
            nextProps.uploadImageList.data.map((item, i) => (
                nextProps.pushArray("ExpenseForm", "contents", "")
            ));
        }
        ...
        this.setState({
            open: nextProps.modal.modalToggle,
    ...
    static getDerivedStateFromProps(nextProps, prevState) {
        ...
        if (!_.isUndefined(nextProps.uploadImageList.data) && prevState.uploadImageList !== nextProps.uploadImageList.data) {
