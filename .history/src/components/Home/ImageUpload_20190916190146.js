...
class ImageUpload extends Component {
    ...
    handleUploadFile(e) {
        ...
        e.fileList.map((item, i) => {
            uploadImageList.push({ id: i, url: e.base64[i], name: item.name })
        })



        let uploadImageList = (e.fileList).reduce((total, item, i) => {
    ...
    render() {
        const { activeStep, open, anchorEl, uploadImageList } = this.state;
                                                    ...
                                                    </Button>
                                                    {
                                                        uploadImageList.map((item, i) =>
                                                            ...
                                                            <img
                                                                ...
                                                                aria-haspopup="true"
                                                                onClick={this.handlePopoverOpen(item)}
                                                                src={item.url}
