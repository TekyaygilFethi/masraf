...
class SpendingInfo extends Component {
    constructor(props) {
        ...
        this.state = {
            ...
            data: [
                { documentDate: '20.05.2019', companyName: 'Idecon', payloadType: 'Kredi Kartı', documentNo: 63123, documentType: 'Fatura', expenseType: 'Konaklama', amount: 63, currency: 'TRY', vatRate: '%8 Kdv', explanation: 'Yok' },
                { documentDate: '20.05.2019', companyName: 'Idecon', payloadType: 'Kredi Kartı', documentNo: 63123, documentType: 'Fatura', expenseType: 'Konaklama', amount: 63, currency: 'TRY', vatRate: '%8 Kdv', explanation: 'Yok' },
                { documentDate: '20.05.2019', companyName: 'Idecon', payloadType: 'Kredi Kartı', documentNo: 63123, documentType: 'Fatura', expenseType: 'Konaklama', amount: 63, currency: 'TRY', vatRate: '%8 Kdv', explanation: 'Yok' },
            ]
        };
