...
const renderFileField = (
    { input, label, handleUploadFile, formControlProps, meta: { touched, error }, ...custom },
) => {
    return (
        <ReactFileReader className="importar" fileTypes={[".jpg", ".jpeg", ".png"]} base64={true} multipleFiles={false} handleFiles={handleUploadFile}>
            <Button variant="contained" color="primary" >{label} <CloudUploadIcon style={{ marginLeft: '5px' }} /></Button>
        </ReactFileReader>
    );
}
